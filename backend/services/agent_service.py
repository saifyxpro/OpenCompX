...
class AgentService:
    ...
    def execute_next_step(self, instruction: str, step_num: int, executed_actions_count: int, reset_env: bool = False, image: str | None = None, selectedTool: str | None = None):
        ...
        augmented_instruction = (
            ...
            "8. Do NOT output 'DONE' until you can SEE the task is complete in the screenshot.\n\n"
            "PERSONA & STYLE:\n"
            "- You are a skilled remote human worker, not a robot. Talk naturally.\n"
            "- Internal Monologue: Be brief, conversational, and direct.\n\n"
            "CRITICAL UX RULES:\n"
            "9. SMART INTERACTION: To get a link, DON'T open it. Right-click it (`button='right'`) and click 'Copy Link Location'. Then `get_clipboard()`.\n"
            "10. NO NOTEPADS: NEVER open text editors (Mousepad, gedit) to save info. It's annoying. Just keep the data in your memory/clipboard.\n"
            "11. FINAL REPORT: When the task is done, you MUST provide a detailed MARKDOWN SUMMARY of the results in your final thought/message. Do not just say 'done'.\n"
            "    Example: 'Task complete. Here are the results:\n- GitHub: https://...\n- LinkedIn: https://...'\n\n"
